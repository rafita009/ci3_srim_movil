                                ...
                                <?php echo form_open_multipart('ProcesosController/registrar_infractor', 'id="formRegistroInfractor"'); ?>
                                    ...
                                    <div class="text-center mb-4">
                                        <div class="position-relative d-inline-block">
                                            <div class="rounded-circle overflow-hidden bg-light d-flex align-items-center justify-content-center" style="width: 150px; height: 150px;">
                                        ...
                                        <small class="form-text text-muted mt-2">Haga clic para agregar una foto</small>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="nombre_inf" class="form-label fw-bold">Nombres<span class="text-danger"> *</span></label>
                                                <input type="text" class="form-control" id="nombre_inf" name="nombre_inf" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="apellidos_inf" class="form-label fw-bold">Apellidos<span class="text-danger"> *</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="cedula_inf" class="form-label fw-bold">Cédula<span class="text-danger"> *</span></label>
                                                <input type="text" class="form-control" id="cedula_inf" name="cedula_inf" maxlength="10" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
...
<script>
    ...
    "order": [[3, 'desc']], // Esto ordena por la primera columna de forma descendente
    "autoWidth": false,
