...
<body id="page-top">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-editar"
                                            data-id="<?php echo $dato['ID_CAUSA']; ?>">
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalCausa" tabindex="-1" role="dialog" aria-labelledby="modalCausaLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- Modal de Edición -->
    <div class="modal fade" id="modalEditarCausa" tabindex="-1" role="dialog" aria-labelledby="modalEditarCausaLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
