            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        Mostrando <span id="elementos-visibles">0</span> de <span id="total-infractores"><?php echo $total_infractores; ?></span> infractores
...
$(document).ready(function() {
    ...
    $('#formInfractor').attr('action', '<?php echo base_url("index.php/InfractoresController/actualizar"); ?>');
    ...
    $('#id_infractor').val(id);
        ...
        $.ajax({
            url: '<?php echo base_url("index.php/InfractoresController/obtener_infractor/"); ?>' + id,
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    if (response.data.F_INFRACTOR_RUTA) {
                        ...
                        $('#photo-preview').attr('src', '<?php echo base_url(); ?>' + ruta_foto);
                        $('#photo-preview').show();
                        $('#default-icon').hide();
                    }
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                if (response.id_infractor) {
                                    const id_infractor = response.id_infractor;
                                ...
                                <div class="modal-footer">
                                    ...
                                    $.get(baseUrl + 'index.php/ProcesosController/cargar_vista_modal/' + id_infractor)
                                        ...
                                        .fail(function(error) {
                                            ...
                                            // Actualizar contenido sin recargar toda la página
                                            actualizarContenido();
                                        });
                                } else {
    ...
    function ordenarInfractores() {
        ...
        function compararElementos(a, b) {
            ...
            switch(orden) {
                ...
                case 'cedula-asc':
                    aText = $(a).find('.badge:contains("Cédula"), .badge:contains("cédula")').text().replace(/\D/g, '');
                    bText = $(b).find('.badge:contains("Cédula"), .badge:contains("cédula")').text().replace(/\D/g, '');
                    return aText - bText;
